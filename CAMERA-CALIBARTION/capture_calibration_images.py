...
#detect checker  board & its parameters
...
while True:
    ...
    if key == ord("q"):
        break
    if key == ord("s") and board_detected == True: # press 's' to store checker board image 
...
# save about 45 images in different angles 

# cd CAMERA-CALIBARTION

# => move to camera_calibration.py